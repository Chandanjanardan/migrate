...
function TextBox() {
  ...
  let data = { text: text.trim(), lang: 'en',gender:"female" };
  ...
  async function handleSubmit() {
    try {
      ...
      const response = await fetch('https://314b-104-198-188-235.ngrok-free.app/TTS/', {
      // const response = await fetch('http://35.224.37.51:6006/TTS', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  return (
    <div className="tts-container">
      ...
      <div className="audiobtn">
        ...
        {audioSrc && (
          <audio controls style={{ position:"absolute",width:"500px",transform:"translatey(120px) translateX(300px)" }}>
